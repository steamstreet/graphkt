...
dependencies {
    ...
    "jvmMainImplementation"("io.ktor:ktor-client-core-jvm:1.2.4")
    "jvmMainImplementation"("io.ktor:ktor-http-jvm:1.2.4")
    ...
    "jsMainImplementation"("io.ktor:ktor-client-core-js:1.2.4")
    "jsMainImplementation"("io.ktor:ktor-http-js:1.2.4")
}
